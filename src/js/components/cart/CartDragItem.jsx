    ...
    render() {
        ...
        return connectDragSource(
            <div className='shop-item'
                ...
                <div className="shop-item-details">
                    <h5 className="shop-item-title"><a href="#/"><small><em>"{this.props.item['model']}"</em></small></a></h5>
                </div>
                <div className="shop-item-details">
                    <h3 className="shop-item-title"><a href="#/"><small>{this.props.item['name']}</small></a></h3>
