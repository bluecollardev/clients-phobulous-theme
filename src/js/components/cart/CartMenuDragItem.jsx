...
import HtmlHelper from 'qc-react/legacy/helpers/HTML.js'
    ...
    render() {
        ...
        return connectDragSource(
            <div className='shop-item'
                ...
                <div className="shop-item-details">
                    <h5 className="shop-item-title h6"><a href="#/">
                        <small><em className='cursive'>{this.props.item['model']}</em></small>
                    </a></h5>
                </div>
                <div className="shop-item-details">
                    <h3 className="shop-item-title"><a href="#/"><strong>{this.props.item['name']}</strong></a></h3>
                ...
                <p className="shop-item-details small" dangerouslySetInnerHTML={{ __html: HtmlHelper.decodeHtmlEntities(this.props.item['description'])}}></p>
                )}
            </div>
        )
    }
